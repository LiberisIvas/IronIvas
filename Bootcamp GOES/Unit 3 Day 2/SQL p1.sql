...
SELECT first_name, last_name, sum(payment_id) AS sum FROM staff AS s INNER JOIN payment AS p ON s.staff_id = p.staff_id WHERE payment_date LIKE "2005-08%" GROUP BY first_name, last_name;
